...
Background: this user have added current course_sec pair into profile
  ...
  And given the following users exist:
    | uni          | uname     | lionmail            |   time_slot       | password     | password_confirmation  | contact         | description                   | phone         | skills  | email_confirmed | confirm_token |
    | aa1000       | UserName1   | aa1000@columbia.edu |   Mon Morning     | 123456       | 123456                 | Wechat: aa1000  | Chinese                       | 559-978-9812  | Ruby  | true            | nil           |
    | aa1100       | UserName2    | aa1100@columbia.edu |   Wed Evening     | 123456       | 123456                 | Wechat: aa1100  | First year master student     | 559-578-9834  | Ruby | true            | nil           |
    | aa1200       | UserName3    | aa1200@columbia.edu |   Fri Afternoon   | 123456       | 123456                 | Wechat: aa1200  |  Undergrad senior             | 781-578-9816  | SQL  | true            | nil           |
