...
Background: this user have added current course_sec pair into profile
  ...
  And given the following users exist:
    ...
    | aa1000       | aa1000    | aa1000@columbia.edu |   Mon Morning     | 123456       | 123456                 | Wechat: aa1000  | Chinese                       | 559-978-9812  | Ruby
    | aa1100       | aa1100    | aa1100@columbia.edu |   Wed Evening     | 123456       | 123456                 | Wechat: aa1100  | First year master student     | 559-578-9834  | Ruby
    | aa1200       | aa1200    | aa1200@columbia.edu |   Fri Afternoon   | 123456       | 123456                 | Wechat: aa1200  |  Undergrad senior             | 781-578-9816  | SQL

  Scenario: See all students' info who have enrolled in the same course and same section
    Given I am on the course_sec page of course_no "COMSW4152" sec_no "001"
    Then I should see user "aa1000" and user "aa1100"
    And I should not see user "aa1200"
